...
static void pm_init_account(struct pm_account *);
static void pm_exit_account(struct pm_account *);

static void pm_init_list(struct pm_list *);
static void pm_exit_list(struct pm_list *);
